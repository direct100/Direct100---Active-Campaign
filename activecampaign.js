...
if(~jQuery('.ac_popover-menu > ul').html().indexOf('Manage Tags')) {
	jQuery('.ac_popover-menu > ul').html().replace('Manage Tags', 'Gerir Tags');
}


if(~jQuery('.ac_popover-menu > ul').html().indexOf('Manage Exclusions')) {
	jQuery('.ac_popover-menu > ul').html().replace('Manage Exclusions', 'Gerir Exclusões');
}

if(~jQuery('.ac_popover-menu > ul').html().indexOf('Personal Batch Actions')) {
	jQuery('.ac_popover-menu > ul').html().replace('Personal Batch Actions', 'Ações em lote');
}